# Import library yang diperlukan untuk pengolahan video, computer vision, dan visualisasi
import os
import requests
...
def download_model():
    ...
    filename = os.path.join(model_dir, "pose_landmarker_lite.task")
...
def process_video(landmarker, video_path, max_seconds=20, x_size=300, y_size=250, shift_x=0, shift_y=0):
    ...
    output_path = 'attachment/output_tracker.mp4'
